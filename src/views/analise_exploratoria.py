...
def mostrar_analise_exploratoria(df):
    ...
    st.caption("**Nota:** Valores próximos a 1.0 indicam forte correlação positiva. O índice de Pearson entre AIOE e Mean provou-se altamente robusto (0.78). *Fonte: Autores do TCC.*")
