...
TOP20_AIOE = [
    ...
    {"Ocupação": "FILÓSOFOS E CIENTISTAS POLÍTICOS",                                "Score": 1.36},
    {"Ocupação": "INSPETORES DE ALUNOS E AFINS",                                    "Score": 1.35},
    {"Ocupação": "MINISTROS DE CULTOS RELIGIOSOS, MISSIONÁRIOS E AFINS",            "Score": 1.32},
    {"Ocupação": "COLETADORES DE APOSTAS E DE JOGOS",                               "Score": 1.28},
    {"Ocupação": "CAIXAS DE BANCO E OPERADORES DE CÂMBIO",                          "Score": 1.27},
    {"Ocupação": "ENGENHEIROS ELETROELETRÔNICOS E AFINS",                           "Score": 1.26},
    {"Ocupação": "OPERADORES DE TELEMARKETING",                                     "Score": 1.26},
